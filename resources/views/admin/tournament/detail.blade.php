...
<div class="content">
    ...
    <ul class="nav nav-pills mb-3 padNav" id="pills-tab" role="tablist">
        ...
        <li class="nav-item padPills">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-bracket" role="tab"
                aria-controls="pills-profile" aria-selected="false">Bracket</a>
        </li>
        <li class="nav-item padPills">
            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-partisipan" role="tab"
                    ...
                    <div class="card-body card-block p-5">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-bracket" role="tabpanel"
                                ...
                                <a class="badge badge-success mr-3" href="{{ URL::route('match.create') }}"><i class="pe-7s-plus pe-2x pe-va"></i> Create</a>
                                <div id="bracket">ini bracket</div>
                            </div>
                            <div class="tab-pane fade" id="pills-partisipan" role="tabpanel"
                                            ...
                                            <div class="card" style="border-radius: 10px;">
                                                <div class="card-img-top" style=" background-color: black;">
                                                    <img id="imgTeam" class="card-img-top imgTeam"
                                                        src="{{ asset('images/team_logo/'. $team->logo_url) }}"
                                                        alt="Card image cap">
                                                </div>
