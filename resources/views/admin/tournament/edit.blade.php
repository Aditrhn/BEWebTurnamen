              ...
              <div class="card">
                  <div class="card-body card-block p-5">
                    <form action="{{ URL::route('event.store') }}" method="post">
                      ...
                      <input type="text" name="title" id="company" placeholder="Enter your tournament name" class="form-control" value="{{$tempevent->title}}">
                        @error('title')
                      ...
                      <div class="row form-group">
                          <div class="col-6">
                              <div class="form-group">
                                ...
                                <input type="number" name="participant" id="city" placeholder="Enter your size team" class="form-control" value="{{$tempevent->participant}}">
                                @error('participant')
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                  {{ $message }}
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <div class="input-group date" id="datetimepicker1">
                                      ...
                                      <input type="text" class="form-control" name="start_date" value="{{$tempevent->start_date}}">
                                    </div>
                                      @error('start_date')
                                      <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        {{ $message }}
                          ...
                          <div class="col-6">
                              <div class="form-group">
                                  ...
                                  <div class="input-group date" id="datetimepicker2">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    <input type="text" class="form-control" name="end_date" value="{{$tempevent->end_date}}">
                                  </div>
                                  <small class="form-text text-muted">(MM/DD/YYYY)</small>
                              </div>
                          </div>
                      ...
                      <div class="row form-group">
                          ...
                          <div class="col-12 col-md-12">
                          <textarea name="description" id="textarea-input" rows="9" placeholder="Enter your description..." class="form-control">{{$tempevent->description}}</textarea>
                          </div>
                          @error('description')
                          <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            {{ $message }}
                      ...
                      <div class="col-md-12 pt-3" style="background-color: white; border-radius: 10px;">
                        ...
                        <div class="row mt-3" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" id="prizepool" name="prizepool" class="form-control">
                                <span class="help-block"></span>
                            </div>
                    ...
                    <div class="col-md-12 pt-3 mt-3" style="background-color: white; border-radius: 10px;">
                        ...
                        <div class="row form-group pb-4">
                            <div class="col col-md-12"><label for="form_message" class=" form-control-label">Terms and Agreement</label></div>
                            <div class="col-12 col-md-12"><textarea name="form_message" id="form_message" rows="5" class="form-control"></textarea></div>
                        </div>
                    </div>
                    <div class="col-md-12">
