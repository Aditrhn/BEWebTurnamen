...
<div class="content">
  <div class="col-md-12 pt-3 pb-3" style="background-color: white; border-radius: 10px;">
      <form action="{{ URL::route('game.store') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
          ...
          <div class="col-md-6">
            <div class=" form-group">
                ...
                <div>
                  <input type="file" id="icon_url" name="icon_url" multiple="" class="form-control-file border rounded">
                </div>
            </div>
            @error('icon_url')
              <div class="alert alert-danger alert-dismissible fade show" role="alert">
