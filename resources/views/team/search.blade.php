                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <h4 class="find-text">{{ $item->name }}</h4>
                                </td>
                                <td><img alt="" id="imgTeam" src="{{ asset('images/team_logo/'.$item->logo_url) }}" class="team-image"></td>
                                <td>
                                    <h4 class="find-text">4 / {{ $item->max_member }}</h4>
                                </td>
                                <td>
                        ...
                        <tbody>
                            <tr>
                                <td><img alt="" id="imgGame" src="assets/img/ML.png" class="team-image"></td>
                                <td>
                                    <h4 class="find-text">Evos-Squad</h4>
                                </td>
                                <td><img alt="" id="imgTeam" src="assets/img/ML.png" class="team-image"></td>
                                <td>
                                    <h4 class="find-text">2 / 5</h4>
                                </td>
                                <td>
                                    <h4 class="find-text">JinXPro</h4>
                                </td>
                            </tr>
                        </tbody>
                        <tbody>
                            <tr>
                                <td><img alt="" id="imgGame" src="assets/img/ML.png" class="team-image"></td>
                                <td>
                                    <h4 class="find-text">RRQ-Legends</h4>
                                </td>
                                <td><img alt="" id="imgTeam" src="assets/img/ML.png" class="team-image"></td>
                                <td>
                                    <h4 class="find-text">3 / 5</h4>
                                ...
                                <td>
                                    <h4 class="find-text">SpaceTropper</h4>
                                </td>
                            </tr>
                        </tbody>
                        @endforelse
